...
{
    [AddComponentMenu("Layout/DPad Layout Group")]
    /// <summary>
    ...
    /// </remarks>
    public class DPadLayoutGroup : LayoutGroup
    {
        /// <summary>
        ...
        private void SetCellsAlongAxis(int axis)
        {
            ...
            for (int i = 0; i < rectChildrenCount; i++)
            {
                ...
                switch (i)
                {
                    case 0: positionX = 2; positionY = 1; break;
                    case 1: positionX = 1; positionY = 2; break;
                    case 2: positionX = 1; positionY = 0; break;
                    case 3: positionX = 0; positionY = 1; break;
                }
