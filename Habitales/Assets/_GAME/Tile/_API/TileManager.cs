...
public class TileManager : MonoBehaviour {
    ...
    [SerializeField] private GameObject tilePrefab; // 3D tile prefab with TileVisualizer
    ...
    /// <summary>
    /// Spawns an entity on a tile using generics.
    /// Example: SpawnEntity<FireEntity>(tile)
    /// </summary>
    public void SpawnEntity<T>(Tile tile) where T : TileEntity, new() {
        ...
        // TODO: Instantiate 2D sprite as child of tile GameObject
        // This will be handled by entity visualization system
    }
    
    /// <summary>
    /// Removes entity from a tile.
    /// </summary>
    public void RemoveEntity(Tile tile) {
        ...
        // TODO: Destroy 2D sprite GameObject
    }
