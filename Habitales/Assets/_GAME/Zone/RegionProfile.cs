...
[CreateAssetMenu(fileName = "RegionProfile", menuName = "Habitales/Region Profile")]
public class RegionProfile : ScriptableObject
{
    [Header("Shape")]
    [Tooltip("Min and max number of tiles to generate for this region.")]
    ...
    public RegionTheme forcedTheme = RegionTheme.LoggedTrees;
    ...
    [Tooltip("Enable to place specific entities at specific offsets from the seed tile. For event-driven regions.")]
    public bool forceSpecificEntities = false;
    public List<ForcedEntityPlacement> forcedEntities = new List<ForcedEntityPlacement>();

    [Header("Azi Dialogue")]
    [Tooltip("Key passed to DialogueManager when this region finishes generating. Maps to an Azi callout line.")]
